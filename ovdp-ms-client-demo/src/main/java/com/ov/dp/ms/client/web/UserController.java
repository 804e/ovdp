...
public class UserController {
    ...
    public User getUser(@ApiParam(name = "id", required = true, value = "用户Id") @PathVariable String id) {
        return this.restTemplate.getForObject("http://ovdp-demo/user/" + id, User.class);
    }
    ...
    public List<User> users() {
        try {
            User[] forObject = this.restTemplate.getForObject("http://ovdp-demo/user/all", User[].class);
    ...
    public String ribbon(){
        ServiceInstance serviceInstance = loadBalancerClient.choose("ovdp-demo");
